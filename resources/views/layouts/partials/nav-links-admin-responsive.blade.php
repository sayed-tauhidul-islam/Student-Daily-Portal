...
<x-responsive-nav-link :href="route('admin.head-teachers.index')" :active="request()->routeIs('admin.head-teachers.*')">{{ __('Head Teachers') }}</x-responsive-nav-link>
...
<x-responsive-nav-link :href="route('profile.edit', ['portal' => 'admin'])" :active="request()->routeIs('profile.*')">{{ __('Profile Settings') }}</x-responsive-nav-link>
