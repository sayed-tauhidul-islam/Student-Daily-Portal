    ...
    <x-slot name="header">
        <div class="flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
            <div>
                ...
                <p class="mt-2 max-w-2xl text-sm text-slate-500 sm:text-base">Create, edit, delete student accounts and their profiles. Search by name, class, school, or area and preview avatars directly in the roster.</p>
            </div>
        ...
        <div class="mx-auto max-w-7xl space-y-6 px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid gap-4 sm:grid-cols-3">
                ...
                <div class="rounded-[1.75rem] border border-slate-200 bg-white p-5 shadow-[0_18px_50px_rgba(15,23,42,0.08)]">
                    ...
                    <p class="mt-2 text-sm text-slate-500">Open a student card and update details right away.</p>
                </div>
            </div>
                ...
                <div class="flex flex-col gap-3 lg:flex-row lg:items-end">
                    <div class="flex-1">
                        ...
                        <div class="relative">
                            ...
                            <input name="q" value="{{ $search ?? '' }}" placeholder="Search by name, email, class, school, area..." class="w-full rounded-2xl border border-slate-200 bg-slate-50 py-3.5 pl-11 pr-4 text-sm outline-none transition focus:border-sky-400 focus:bg-white focus:ring-4 focus:ring-sky-100">
                        </div>
                    </div>
                    <div class="flex gap-2">
                        ...
                        @if(!empty($search))
                            <a href="{{ route('admin.students.index') }}" class="rounded-2xl border border-slate-200 bg-white px-5 py-3.5 text-sm font-semibold text-slate-700 transition hover:bg-slate-50">Reset</a>
                        @endif
                    </div>
                </div>
            </form>
            ...
            <div class="overflow-hidden rounded-[2rem] border border-slate-200 bg-white shadow-[0_18px_50px_rgba(15,23,42,0.08)]">
                <div class="flex flex-col gap-3 border-b border-slate-200 px-6 py-5 sm:flex-row sm:items-end sm:justify-between">
                    <div>
                        ...
                        <h3 class="mt-1 text-2xl font-black text-slate-950">Manage student profiles</h3>
                    </div>
                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-slate-200 text-sm">
                        ...
                        <tbody class="divide-y divide-slate-100 bg-white text-slate-700">
                                ...
                                <tr class="transition hover:bg-slate-50/80">
                                    ...
                                    <td class="px-6 py-5">
                                        <div class="flex flex-wrap gap-2">
                                            <a href="{{ route('admin.students.edit', $student) }}" class="rounded-full border border-sky-200 bg-sky-50 px-3 py-1.5 text-xs font-semibold text-sky-700 transition hover:bg-sky-100">Edit</a>
                            ...
                            @empty
                                <tr><td colspan="4" class="px-6 py-12 text-center text-slate-500">No students found.</td></tr>
                            @endforelse
                        </tbody>
                    </table>
                </div>
